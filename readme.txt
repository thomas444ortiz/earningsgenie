About EarningsGenie:
    ...
    post earnings call transcrips online for free (BAMSec, Seeking Alpha, and The Motley Fool), but none of them have built out any AI features yet and I expect it will
...
Features (by page):
    ...
    -Registration Page ('/register'): Presents a form for the user to register a new account. Upon registration, it logs them in and redirects to the landing page.
...
Distinctiveness and Complexity:
    ...
    -Complexity: This project is way way more lines of code than any project from this class, and took me way longer to build.
...
What I will do next if I want to continue to put this online:
    ...
    -Put sentiment analysis functionality (several API's for this)
